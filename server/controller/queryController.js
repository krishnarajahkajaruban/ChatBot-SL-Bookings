  ...
  try {
    ...
    if (queryResponse) {
      ...
      return res.status(200).json({
        response: "I'm sorry, but I don't understand what you're asking. Could you please contact the SL Bookings for more information? Hotline : 021-000-0000, Email : info@slbookings.com, Website : slbookings.lk."
      });
    }
